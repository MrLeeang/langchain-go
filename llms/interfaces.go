...
type LLM interface {
	...
	Chat(ctx context.Context, messages []ChatCompletionMessage) (ChatCompletionResponse, error)
}
...
type ChatStreamer interface {
	...
	ChatStream(ctx context.Context, messages []ChatCompletionMessage) (*ChatCompletionStream, error)
}
